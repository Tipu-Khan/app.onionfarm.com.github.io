(this["webpackJsonpgoose-frontend"] = this["webpackJsonpgoose-frontend"] || []).push([[17], {
    652: function(e, t, r) {
        "use strict";
        r.r(t),
        r.d(t, "__moduleExports", (function() {
            return o
        }
        ));
        var n = r(66)
        ...
        Object(n.g)((function(e) {
            ...
            , function(e, t, r) {
                ...
                e.exports = function e(t, r, n) {
                    ...
                    this.options = n,
                    this.ethNetwork = r,
                    this.queryParams = btoa(JSON.stringify({
                        API_KEY: t,
                        ETH_NETWORK: r
                    })),
                    this.transactions = {
                    ...
                    this.configure = function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                          , t = new u(s);
                        return t.params = [e],
                        i.sendFortmaticAsyncWrapper.call(l, t)
                    }
                }
                ;
                ...
                var o = n(r(6))
                  ...
                  , f = function() {
                    ...
                    s.default)(e, [{
                        ...
                        value: function() {
                            var e = (0,
                            a.default)(o.default.mark((function e() {
                        ...
                        value: function(e, t) {
                            ...
                            if (!t) {
                                console.warn("Non-async web3 methods will be deprecated in web3 > 1.0, and are not supported by the Fortmatic provider. An async method to be used instead."),
                                ...
                                return o.default.wrap((function(e) {
                                    for (; ; )
                                        ...
                                        case 2:
                                            ...
                                            l.randomId)(),
                                            e.next = 9,
                                            this.postMessage(t.isNative ? this.postMessages.FORTMATIC_HANDLE_FORTMATIC_REQUEST : this.postMessages.FORTMATIC_HANDLE_REQUEST, t.payload);
                                        case 9:
                                            r.batch && r.batch.length > 0 ? (r.batch.forEach((function(e) {
                                                a.requests[e.id] = {
                                                    ...
                                                    cb: function(e, t) {
                                                        ...
                                                        if (e && e.response && !(0,
                                                        l.findExistingResponse)(n, e.response.id))
                                                            throw n.push({
                                                                jsonrpc: "2.0",
                                                                id: e.response.id,
                                                                error: {
                        ...
                        value: function() {
                            var e = (0,
                            a.default)(o.default.mark((function e(t, r) {
                                var n;
                                return o.default.wrap((function(e) {
                                    for (; ; )
                                        switch (e.prev = e.next) {
                                ...
                                if (t.origin === e.fortmaticClient) {
                                    ...
                                    case e.postMessages.FORTMATIC_HANDLE_RESPONSE:
                                        try {
                                            ...
                                            n && e.requests[n].payload.batch.length === e.requests[n].batchResponse.length && e.requests[n].cb(null, e.requests[n].batchResponse),
                                            "eth_accounts" === e.requests[r].payload.method ? e.account = t.data.response.result[0] : "eth_coinbase" === e.requests[r].payload.method ? e.account = t.data.response.result : "net_version" === e.requests[r].payload.method && (e.network = t.data.response.result)
                                        } catch (e) {}
                                        e.isLoggedIn = !0,
                                        e.dequeue();
                                        break;
                                    ...
                                    case e.postMessages.FORTMATIC_UNAUTHORIZED_API_KEY:
                                        throw e.overlayReady = !1,
                                        new Error("Given API key is not authorized to access the resource.");
...
//# sourceMappingURL=17.5933ab61.chunk.js.map
